...
public class ManagersController {
    ...
    private void setupEndpoints() {
        ...
        post("/managers", (req, res) -> {
            int departmentId = Integer.parseInt(req.queryParams("department"));     // query the params from the post-er "name" attribute sent in create.vtl
            Department department = DBHelper.find(departmentId, Department.class);  // turn it into Department object
